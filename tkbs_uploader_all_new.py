...
class Config:
    def __init__(self, config_parameters=None):
        ...
        self.user_garbage_line_width = "0.5"
...
def upload_parallel():
    ...
    for path in text_files:
            ...
            print(path)
            allfolders += 1
            if os.path.isdir(path+ "transkribus_output/"):
    ...
    #print(pathes)
    while pathes:
        print("empty folders counter: " + str(emptyfolders))
        print("number of all folders: " + str(allfolders))
        for path in pathes:
                         #print("/home/aor7/work/historical_press/OCR_Pipeline/hamagid-1885-1900/1885/01/01/")
